...
function formatMotd(text) {
    ...
    const textShadowMap = {
        '0': '4px 4px 0 #111111', '1': '4px 4px 0 #000033', '2': '4px 4px 0 #003300',
        '3': '4px 4px 0 #003333', '4': '4px 4px 0 #330000', '5': '4px 4px 0 #330033',
        '6': '4px 4px 0 #663300', '7': '4px 4px 0 #444444', '8': '4px 4px 0 #222222',
        '9': '4px 4px 0 #222266', 'a': '4px 4px 0 #226622', 'b': '4px 4px 0 #226666',
        'c': '4px 4px 0 #662222', 'd': '4px 4px 0 #662266', 'e': '4px 4px 0 #666622',
        'f': '4px 4px 0 #666666'
      };      
